...
public:
   ...
   TH1F *h_w_decay_jet;
   TH1F *h_top_to_b_decay_hadronic;
   TH1F *h_top_to_b_decay_leptonic;
   TH1F *h_top_to_w_decay_hadronic;
   TH1F *h_w_decay_lepton;
   TH1F *h_top_to_w_decay_leptonic;
   TH1F *h_ttbar_invm;
   
   TH1F *h_w_decay_jet_noz;
   TH1F *h_w_decay_lepton_noz;
   TH1F *h_top_to_b_decay_hadronic_noz;
   TH1F *h_top_to_b_decay_leptonic_noz;
   TH1F *h_top_to_w_decay_hadronic_noz;
   TH1F *h_top_to_w_decay_leptonic_noz;
   TH1F *h_ttbar_invm_noz;
